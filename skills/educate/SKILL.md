---
name: educate
description: Teach a human developer to deep mastery after a coding session. Use after code edits, bug fixes, refactors, feature work, dependency or config changes, test updates, PR feedback fixes, or any completed implementation when Claude should make sure the developer truly understands the problem, the solution, the design decisions, the edge cases, and the broader impact — incrementally, confirming mastery at each stage before moving on, and quizzing to verify understanding rather than just explaining.
---
